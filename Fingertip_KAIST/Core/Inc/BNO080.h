...
//#define BNO080_SPI_SCLK_CLK		AHB1_GRP1_PERIPH_GPIOB
//
//#define BNO080_SPI_MISO_PIN		GPIO_PIN_14
//#define BNO080_SPI_MISO_PORT	GPIOB
//#define BNO080_SPI_MISO_CLK		AHB1_GRP1_PERIPH_GPIOB
//
//#define BNO080_SPI_MOSI_PIN		GPIO_PIN_15
//#define BNO080_SPI_MOSI_PORT	GPIOB
//#define BNO080_SPI_MOSI_CLK		AHB1_GRP1_PERIPH_GPIOB
//
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//#define CHIP_SELECT(BNO080)		HAL_GPIO_ResetOutputPin(BNO080_SPI_CS_PORT, BNO080_SPI_CS_PIN)
//#define CHIP_DESELECT(BNO080)	GPIO_SetOutputPin(BNO080_SPI_CS_PORT, BNO080_SPI_CS_PIN)
//
//#define WAKE_HIGH()				GPIO_SetOutputPin(BNO080_PS0_WAKE_PORT, BNO080_PS0_WAKE_PIN)
//#define WAKE_LOW()				GPIO_ResetOutputPin(BNO080_PS0_WAKE_PORT, BNO080_PS0_WAKE_PIN)
//
//#define RESET_HIGH()			GPIO_SetOutputPin(BNO080_RST_PORT, BNO080_RST_PIN)
//#define RESET_LOW()				GPIO_ResetOutputPin(BNO080_RST_PORT, BNO080_RST_PIN)
//#define CHIP_SELECT(x)          HAL_GPIO_WritePin(IMU_CS_GPIO_Port, IMU_CS_Pin, GPIO_PIN_RESET)
//#define CHIP_DESELECT(x)        HAL_GPIO_WritePin(IMU_CS_GPIO_Port, IMU_CS_Pin, GPIO_PIN_SET)
//
//#define WAKE_HIGH()             HAL_GPIO_WritePin(IMU_WAKE_GPIO_Port, IMU_WAKE_Pin, GPIO_PIN_SET)
//#define WAKE_LOW()              HAL_GPIO_WritePin(IMU_WAKE_GPIO_Port, IMU_WAKE_Pin, GPIO_PIN_RESET)
//
//#define RESET_HIGH()            HAL_GPIO_WritePin(IMU_NRST_GPIO_Port, IMU_NRST_Pin, GPIO_PIN_SET)
//#define RESET_LOW()             HAL_GPIO_WritePin(IMU_NRST_GPIO_Port, IMU_NRST_Pin, GPIO_PIN_RESET)
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
